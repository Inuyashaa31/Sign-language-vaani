...
export function NavbarDefault() {
    ...
    const navList = (
        <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-8">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#90A4AE" class="size-12">
                    <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
                    <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
                </svg>


                <a href="/" className="flex items-center text-2xl text-black hover:border-b-2  hover:border-red-500">
                    Home
                </a>
            ...
            >
                ...
                <a href="/model" className="flex items-center text-2xl text-black hover:border-b-2  hover:border-red-500">
                    Model
                </a>
            </Typography>
            ...
            >
                ...
                <a href="/tutorial" className="flex items-center text-2xl text-black hover:border-b-2  hover:border-red-500">
                    Tutorial
                </a>
            </Typography>
    ...
    return (
        <Navbar className=" px-4 py-2 lg:px-8 lg:py-4 items-center ">
            <div className="flex mx-32 items-center gap-x-24">

                <img src={logo} className="flex h-[20vh]" />

                <div className="hidden lg:block text-black">{navList}</div>
                <div className="flex items-center gap-x-3">
                    ...
                    <Button
                        variant="gradient"
                        size="sm"
                        className="hidden lg:inline-block bg-black text-white items-center w-28 rounded-2xl text-xl"
                    >
