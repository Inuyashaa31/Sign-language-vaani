        ...
        <div>
            <div id="bg-wrap">
                <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
                    ...
                    {/* Reduced width and height from 100% to 90% to prevent touching the borders */}
                    <rect x="13.744%" y="1.18473%" width="90%" height="90%" fill="url(#Gradient1)" transform="rotate(334.41 50 50)">
                    ...
                    <rect x="-2.17916%" y="35.4267%" width="90%" height="90%" fill="url(#Gradient2)" transform="rotate(255.072 50 50)">
                        <animate attributeName="x" dur="23s" values="-25%;0%;-25%" repeatCount="indefinite" />
                        <animate attributeName="y" dur="24s" values="0%;50%;0%" repeatCount="indefinite" />
                        <animateTransform attributeName="transform" type="rotate" from="0 50 50" to="360 50 50" dur="12s" repeatCount="indefinite" />
                    </rect>

                    <rect x="9.00483%" y="14.5733%" width="90%" height="90%" fill="url(#Gradient3)" transform="rotate(139.903 50 50)">
